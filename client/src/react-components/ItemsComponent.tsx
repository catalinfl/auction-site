...
const ItemsComponent = ({backgroundHighlight, title, description}: ItemsComponentProps) => {
    return (
    <div className={`${backgroundHighlight ? "bg-primary" : "bg-neutral"} max-w-sm mx-auto md:max-w-2xl lg:max-w-5xl xl:max-w-7xl p-3 border border-primary rounded-lg mb-3`}>
                <div className="pl-3">
